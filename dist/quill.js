...
var Emitter = function (_EventEmitter) {
  ...
  _createClass(Emitter, [{
    ...
    value: function emit() {
      ...
      (_get2 = _get(Emitter.prototype.__proto__ || Object.getPrototypeOf(Emitter.prototype), 'emit', this)).call.apply(_get2, [this].concat(Array.prototype.slice.call(arguments)));
    }
  }, {
    key: 'handleDOM',
...
var _snow = __webpack_require__(44);

var _snow2 = _interopRequireDefault(_snow);

var _snowWithPayment = __webpack_require__(109);
        ...
        case 'payment':
          {
            ...
            if (this.linkRange) {
              this.quill.formatText(this.linkRange, 'payment', value, _emitter2.default.sources.USER);
              delete this.linkRange;
            } else {
              this.restoreFocus();
              this.quill.format('payment', value, _emitter2.default.sources.USER);
...
SnowTooltipWithPayment.TEMPLATE = ['<select>', '<option value="link">Link</option>', '<option value="payment">Payment</option>', '</select>', '<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join('');
