...
var format_1 = __webpack_require__(17);
var leaf_1 = __webpack_require__(18);
...
var equal = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"deep-equal\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var _eventemitter = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"eventemitter3\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var _deepEqual = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"deep-equal\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var Link = function (_Inline) {
  ...
  _createClass(Link, [{
    ...
    key: 'create',
    value: function create(value) {
      var _value$href2 = value.href,
          href = _value$href2 === undefined ? value : _value$href2,
          rel = value.rel;

      var node = _get(Link.__proto__ || Object.getPrototypeOf(Link), 'create', this).call(this, href);
    ...
    value: function formats(domNode) {
      ...
      var hasRel = rel !== null;
      return hasRel ? { href: href, rel: rel } : href;
    }
  }, {
    key: 'sanitize',
...
var _scroll = __webpack_require__(21);
...
var _colorPicker = __webpack_require__(56);
...
exports.default = exports.SnowTooltip = undefined;
...
var _indent = __webpack_require__(60);

var _blockquote = __webpack_require__(61);
...
var _italic = __webpack_require__(64);
...
var _snow = __webpack_require__(43);

var _snow2 = _interopRequireDefault(_snow);

var _snowWithPayment = __webpack_require__(105);

var _snowWithPayment2 = _interopRequireDefault(_snowWithPayment);
...
_core2.default.register({
  ...
  'themes/snow-with-payment': _snowWithPayment2.default,
...
exports.default = exports.SnowTooltipWithPayment = undefined;
...
var SnowThemeWithPayment = function (_SnowTheme) {
  _inherits(SnowThemeWithPayment, _SnowTheme);

  function SnowThemeWithPayment() {
    _classCallCheck(this, SnowThemeWithPayment);

    return _possibleConstructorReturn(this, (SnowThemeWithPayment.__proto__ || Object.getPrototypeOf(SnowThemeWithPayment)).apply(this, arguments));
  }

  _createClass(SnowThemeWithPayment, [{
    key: 'extendToolbar',
    value: function extendToolbar(toolbar) {
      toolbar.container.classList.add('ql-snow');
      this.buildButtons([].slice.call(toolbar.container.querySelectorAll('button')), _icons2.default);
  ...
  return SnowThemeWithPayment;
}(_snow2.default);

SnowThemeWithPayment.DEFAULTS = (0, _extend2.default)(true, {}, _snow2.default.DEFAULTS);

var SnowTooltipWithPayment = function (_SnowTooltip) {
  _inherits(SnowTooltipWithPayment, _SnowTooltip);

  function SnowTooltipWithPayment() {
    _classCallCheck(this, SnowTooltipWithPayment);

    return _possibleConstructorReturn(this, (SnowTooltipWithPayment.__proto__ || Object.getPrototypeOf(SnowTooltipWithPayment)).apply(this, arguments));
  }

  _createClass(SnowTooltipWithPayment, [{
    key: 'listen',
    value: function listen() {
      var _this3 = this;

      _get(SnowTooltipWithPayment.prototype.__proto__ || Object.getPrototypeOf(SnowTooltipWithPayment.prototype), 'listen', this).call(this);
      var select = this.root.querySelector('select.format-select');
    ...
    value: function save() {
        ...
        case 'payment':
          {
            ...
            if (this.linkRange) {
              this.quill.formatText(this.linkRange, 'link', { href: value, rel: 'payment' }, _emitter2.default.sources.USER);
              delete this.linkRange;
            } else {
              this.restoreFocus();
              this.quill.format('link', { href: value, rel: 'payment' }, _emitter2.default.sources.USER);
            }
            this.quill.root.scrollTop = scrollTop;
            break;
          }
      ...
      _get(SnowTooltipWithPayment.prototype.__proto__ || Object.getPrototypeOf(SnowTooltipWithPayment.prototype), 'save', this).call(this);
      this.textbox.value = '';
      this.hide();
    }
  }]);
...
var _quill = __webpack_require__(59);
